...
{{/*
Derive public URL from global configuration
*/}}
{{- define "openops.publicUrl" -}}
{{- .Values.global.publicUrl -}}
{{- end }}

{{/*
Derive hostname from public URL (strips protocol and port for use in ingress)
*/}}
{{- define "openops.hostname" -}}
{{- $url := .Values.global.publicUrl | trimPrefix "http://" | trimPrefix "https://" -}}
{{- if contains ":" $url -}}
{{- $url | splitList ":" | first -}}
{{- else -}}
{{- $url -}}
...
{{/*
Check if public URL uses HTTPS
*/}}
{{- define "openops.isHttps" -}}
{{- if hasPrefix "https://" .Values.global.publicUrl -}}
true
{{- end -}}
{{- end }}
